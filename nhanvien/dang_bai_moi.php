...
if (isset($_GET['action']) && $_GET['action'] === 'delete' && isset($_GET['id'])) {
    ...
    $stmt->close();
    header("Location: dang_bai_moi.php"); exit();
}
// --- XỬ LÝ LƯU ---
...
<div class="sidebar">
    ...
    <ul class="nav-menu">
        <li><a href="trang_chu.php" class="nav-link-custom"><i class="fas fa-house-chimney"></i>Tổng quan</a></li>
        <li><a href="dang_bai_moi.php" class="nav-link-custom active"><i class="fas fa-rectangle-ad"></i>Bài viết quảng bá</a></li>
    ...
    function deletePost(id, title) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `dang_bai_moi.php?action=delete&id=${id}`;
            }
        });
    }
